...
public:
	...
	virtual void USBDevicesChanged(USBInterface::TDeviceList& Devices) = 0;
protected:
	int m_RefCount;
};
...
public USBInterface::IUSBDeviceChangeClient
{
public:
...
private:
	...
	std::set<u32> m_SeenDevices;
	TDeviceInsertionHooks m_DeviceInsertionHooks;
	u32 m_InsertionHookId;
};

class CWII_IPC_HLE_Device_usb_oh0_dev :
public IWII_IPC_HLE_Device_usb_x,
public USBInterface::IUSBDeviceChangeClient, public USBInterface::IUSBDeviceClient
{
public:
